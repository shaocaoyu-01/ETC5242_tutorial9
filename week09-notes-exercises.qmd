...
ggplot(data2016, aes(x = reorder(Country, Total), y = Total)) +
  geom_col(width = 0.7) +
  coord_flip() +
  labs(title = "Figure 2. Medal counts", x = NULL, y = "Total medals") +
  theme_minimal(base_size = 12)
```
...
3.  Describe the distribution of the total medal counts. What is the main
    noticeable feature?
The united states ranked first in the total medal counts
...
```{r}
library(ggplot2)
ggplot(oly, aes(x = Total_2012, y = Total_2016, label = Country)) +
  geom_point(color = "steelblue", size = 3) +
  geom_text(vjust = -0.8, size = 3.5) +
  geom_abline(intercept = 0, slope = 1, linetype = "dashed", color = "red") +
  labs(
    x = "Total Medals in 2012",
    y = "Total Medals in 2016",
    title = "Comparison of Olympic Medal Counts: 2016 vs 2012"
  ) +
  theme_minimal()
